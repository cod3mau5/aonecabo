...
?>
<style>
.summary-block { border-bottom: 2px solid #d7d9de; margin-bottom: 30px; }
.summary-block:last-child { border-bottom: 0px; }
.summary-content { padding: 0; }
.summary-price { color: #094bde; font-size: 16px; font-weight: 400; letter-spacing: -1px; margin-bottom: 0px; display: inline-block; float: right; }
...
.widget { margin-bottom: 30px; background-color: #e9ebef; padding: 15px; border-radius: 6px; }
            ...
            <div class="tab-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <select id="start_location" name="start_location" class="form-control" required="">
                                    ...
                                    <option value="0"
                                        <?php echo ($start_location!='') ? 'selected="selected"' : ''?>
                                    >Los Cabos Int. Airport
                                    </option>
                                    <?php foreach ($resorts as $row): ?>
                                        <option
                                            value="<?=$row->id;?>"
                                            <?php echo ($row->id == $start_location) ? 'selected="selected"' : ''; ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <select id="end_location" name="end_location" class="form-control" required="">
                                    ...
                                    <option value="0"<?php echo ($end_location!='') ? 'selected="selected"' : ''?>>Los Cabos Int. Airport</option>
                                    <?php foreach ($resorts as $row): ?>
                                        <option
                                            value="<?=$row->id;?>"
                                            <?php echo ($row->id == $end_location) ? 'selected="selected"' : ''; ?>
                                            data-zone="<?=$row->zone_id;?>"
                                        >
                                            <?=htmlentities($row->name);?>
                                        </option>
                ...
                <div class="tab-pane" id="step3" role="tabpanel">
                    ...
                    <p class="text-center">
                        ...
                        If you wish to get in touch with us please call +52 1 (624) 229 3891 or email <a href="mailto:aonecabo@gmail.com">aonecabo@gmail.com</a>
                    </p><br>
